...
Important: NumPy can be very slow without OpenBLAS. Make sure [OpenBLAS](https://github.com/OpenMathLib/OpenBLAS) is installed on your device for acceptable performance.
